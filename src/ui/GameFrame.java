...
public class GameFrame extends JFrame implements KeyListener {
     ...
     * includes a label that display's the users total score and remaining number of lives. The
    ...
    private void newGame() {
        ...
        if (model != null) {
            model.removeAllPropertyChangeListeners(); // clean up listeners in old model
        }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch (keyCode) {
            case KeyEvent.VK_UP:
            case KeyEvent.VK_W:
                model.updatePlayerCommand(MazeGraph.Direction.UP);
                directionalKeyPressed = true;
                break;

            case KeyEvent.VK_RIGHT:
            case KeyEvent.VK_D:
                model.updatePlayerCommand(MazeGraph.Direction.RIGHT);
                directionalKeyPressed = true;
                break;

            case KeyEvent.VK_DOWN:
            case KeyEvent.VK_S:
                model.updatePlayerCommand(MazeGraph.Direction.DOWN);
                directionalKeyPressed = true;
                break;

            case KeyEvent.VK_LEFT:
            case KeyEvent.VK_A:
                model.updatePlayerCommand(MazeGraph.Direction.LEFT);
                directionalKeyPressed = true;
                break;
        ...
        if (directionalKeyPressed && state != PlayState.RUNNING) {
