...
public class GameModel {
    ...
    /**
     * The direction associated with most recent player input.
     */
    private Direction direction; // Uses the imported Direction enum

    /**
     * Returns the Direction object associated with most recent player input.
     */
    ...
    /**
     * Updates the field 'direction' to the most recent player input.
     */
    ...
    public void processPacMannArrival() {
        ...
        GameModel.Item item = itemAt(v);  // store if it is a dot, pellet, none
        int oldScore = score;
...
//                if (myAm.p() == am.p()) { continue; }
    ...
    private static final class UnorderedPair<T> {
        ...
        /** The first element of the pair, ordered by hash code. */
        private final T elem1;
        /** The second element of the pair, ordered by hash code. */
